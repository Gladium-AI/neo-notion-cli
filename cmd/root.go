...
func init() {
	...
	pf.Bool("raw", false, "Output exact API bytes, no formatting")
	pf.Bool("full", false, "Show full API response (skip normalization)")
	...
	_ = viper.BindPFlag("full", pf.Lookup("full"))
